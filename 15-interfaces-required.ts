...
class User implements UserProperties, IUser, UserOptionals {
  userId: string;
  firstname: string;
  lastname: string;
  age: number;
  ...
  constructor(obj: Partial<UserProperties>) {
...
const properties: Required<UserProperties> & Partial<UserOptionals> = {
